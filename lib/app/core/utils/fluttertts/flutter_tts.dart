...
//       String fileContent = await file.toString();

//       List<String> chunks = splitTextIntoChunks(fileContent, 20 * 1024);
...
//       int end = (i + chunkSize < textLength) ? i + chunkSize : textLength;
...
//           _buildButtonColumn(Colors.orange, Colors.orangeAccent, Icons.file_open,
//               'PICK FILE', _pickFile),
//         ],
//       ),
//     );
